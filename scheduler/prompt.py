...
def exercise_prompt(sex, state, purpose, place, body_component, routine, time):
  return f"""I want you to recommend me of workout routine.
    ...
    'VALUES FOR JSON 3' : You should recommend duration of the exercise formatted as 'minute'.
      you can refer the example form of the response is, {workout_plan_form}.
      please keep the language type of the form, keys for english and values for Korean.
  """
workout_plan_form ={
  'workout_plan':[
  {'Monday':[
  {"exercise_type":"체스트 프레스", "duration":"30", "repetition":"10회씩 4세트", "weight":'1RM 의 80%'}]}],
   'reason': 'string'
}
meal_plan_form = {
  'meal_plan':[
  {'Monday':[
  {'time':'아침', 
   'menu':[{'food':'닭가슴살 샐러드', 'kcal':'50'}, {'food':'우유 한잔', 'kcal':'70'}], 
